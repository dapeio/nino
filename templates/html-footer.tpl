		...
		<footer>
	      ...
	      <div class="ui-grid-100 ui-grid-l-33 ui-pb-2">
					<img src="[[/nino/dir]]/images/.demo/logo-invert.png" class="ui-footer-logo ui-mb-2" alt="[[/company/name]]">
      ...
      <section class="ui-footer-legal ui-grid-row">
	      ...
	      <div class="ui-grid-100 ui-grid-l-50 ui-pb-1">
	      	<div class="ui-footer-localepicker">
					[navigation]
						[[/webpage/legal/uri]]:[[/webpage/legal/name]]
					[/navigation]
	        [localepicker]
	        </div>
	      </div>
		...
		<div class="js-cookie-banner" id="cookie-banner">
			<p>[[/cookiebanner/info/text]] <a href="[[/webpage/legal/uri]]">[[/cookiebanner/label/legal]]</a></p>
