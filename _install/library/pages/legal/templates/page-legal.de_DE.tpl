...
<section id="legal-privacy" class="ui-section">
	<div class="ui-grid-row">
		...
		<div class="ui-grid-100">
		  ...
		  <p>Ihre Daten werden zum einen dadurch erhoben, dass Sie uns diese mitteilen, z.&nbsp;B. über ein Kontaktformular.</p>
		  <p>Andere Daten werden automatisch beim Besuch der Website durch unsere IT-Systeme erfasst. Das sind vor allem technische Daten (z.&nbsp;B. Internetbrowser, Betriebssystem, Uhrzeit des Seitenaufrufs). Die Erfassung dieser Daten erfolgt automatisch, sobald Sie diese Website betreten.</p>
		  ...
		  <p>Unser Hoster wird Ihre Daten nur insoweit verarbeiten, wie dies zur Erfüllung seiner Leistungspflichten erforderlich ist und unsere Weisungen in Bezug auf diese Daten befolgen. Mit unserem Hoster besteht ein Vertrag über Auftragsverarbeitung gemäß Art. 28 DSGVO.</p>
		  ...
		  <p>Wenn Sie diese Website benutzen, werden verschiedene personenbezogene Daten erhoben. Personenbezogene Daten sind Daten, mit denen Sie persönlich identifiziert werden können. Diese Datenschutzerklärung erläutert, welche Daten wir erheben und wofür wir sie nutzen. Sie erläutert auch, wie und zu welchem Zweck das geschieht.</p>
		  ...
		  <h5>Cookies (technisch notwendige Cookies)</h5>
		  <p>Unsere Website verwendet ausschließlich technisch notwendige Cookies. Diese Cookies sind für den Betrieb der Website und deren Grundfunktionen (z.&nbsp;B. Seitennavigation, Zugriff auf geschützte Bereiche) erforderlich.</p>
		  <p>Rechtsgrundlage ist Art. 6 Abs. 1 lit. f DSGVO in Verbindung mit § 25 Abs. 2 Nr. 2 TTDSG.</p>
		  <p>Es werden keine Cookies zu Analyse-, Tracking- oder Werbezwecken gesetzt.</p>
		  <p>Technisch notwendige Cookies werden nach Ende der Sitzung automatisch gelöscht oder dienen ausschließlich der Aufrechterhaltung sicherheitsrelevanter oder funktionaler Prozesse.</p>
		  ...
		  <h5>Anfrage per E-Mail oder Telefon</h5>
