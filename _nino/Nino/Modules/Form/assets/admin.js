 ...
 *	Nino										Framework
 *	editor.js								The Form module's /_admin panel, "Anfragen": read-only
 *													view of every contact-form submission \Nino\Modules\Form
 *													records (in addition to the mail itself) - see
 *													Modules\Form\Editor beside this file. Nothing here writes
 *													anything, it only lists. Ships with the module: it is in
 *													the editor bundle exactly while the module is active.
 *
 *	@package								Dape/Nino
	...
	Nino.admin.submissions = {
		...
		_renderList : function( entries ) {
			...
			exportBtn.addEventListener( 'click', function() {
				Nino.admin.exportCsv( Nino.content.getText('/_admin/submissions/label/filename'), entries );
			} );
