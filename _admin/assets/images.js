...
( function(wn,dc,dE,bd) {
	...
	Nino.admin.images = {
		...
		_renderSlotField : function( slot ) {
			...
			imageUri.className = 'admin-field-name';
			...
			dimensions.textContent = Nino.content.getText('/_admin/elements/label/image-target')+ ' '+ slot.width+ ' × '+ slot.height+ ' px';
			fieldset.appendChild( dimensions );

			const imageWrap = dc.createElement('div');
			imageWrap.className = 'admin-field-image';
