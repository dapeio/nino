 ...
 *													\Nino\Shortcodes\Newsletter records - see _admin/Admin.php's
...
( function(wn,dc,dE,bd) {
	...
	Nino.admin.newsletter = {
		...
		_renderList : function( entries ) {
			...
			entries.forEach( function( entry ) {
				ul.appendChild( Nino.admin.newsletter._renderEntry( entry ) );
			} );
		...
		_renderEntry : function( entry ) {
			...
			deleteBtn.addEventListener( 'click', function() { Nino.admin.newsletter._delete( entry.email ) } );
		...
		_renderBcc : function( entries ) {
			...
			exportBtn.addEventListener( 'click', function() {
				Nino.admin.exportCsv( 'newsletter.csv', entries );
			} );
	...
	Nino.events.bindCallback( 'ready', Nino.admin.newsletter.init );
