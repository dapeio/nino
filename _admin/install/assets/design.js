 ...
 *													that decide how far each is pushed. the Design module generates
 *													the tokens from them and this step writes the
 *													stylesheet, see _admin/install/Install.php's Themes class.
 *
 ...
 *													colour maths lives in the Design module, and a second copy of it
...
( function(wn,dc,dE,bd) {
	...
	Nino.install.design = {
		...
		_ready 		: false,
		// Null means "this delivery has no Design module", which is a different
		 ...
		 *	a knob added to the module's Tokens appears in this step without the
		 *	wizard template gaining a line - which is what keeps the installer
		 *	and the Design panel showing the same set rather than drifting apart.
		 *
		 *	@return		void
		 */
		 ...
		 *
		 *	The document is built by the Design module - one answer to "what does this
		 ...
		 *	button of its own. A delivery without the Design module has nothing to write
