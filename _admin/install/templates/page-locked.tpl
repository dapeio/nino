...
<html lang="en">
	...
	<body>
		<div id="install-locked-wrap" class="nino-admin nino-admin-auth nino-admin-auth-card">
			...
			<p class="nino-admin-hint">This project is set up, so the wizard refuses to run. Sign in at <a href="[[/nino/dir]]/_admin/">/_admin</a> instead. It's safe to delete the wizard's folder: <code>rm -rf _admin/install</code>.</p>
		</div>
	</body>
</html>
