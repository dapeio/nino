<?php return [
	...
	'areas' => [
		...
		'articles' => [
			...
			'item' => [ 'tag' => 'article', 'class' => 'ui-article ui-article--alt ui-mb-3 ui-article--grid' ],
			'styles' => [
				...
				'borderless' => [ 'label' => 'Borderless · 3 columns', 'class' => 'ui-grid-m-33 ui-article--borderless' ],
			],
			'recommend' => [
				'style' => 'three-columns',
				'components' => [
