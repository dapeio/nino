<!--	The page the Design panel previews against.
	...
	defines. Nothing here belongs to the Design module.

	The markup is the live markup, lifted from the section presets the Template
	Builder inserts (_admin/install/library/pages/.demo-catalogue): the same nesting,
	...
	project's own header and footer units, prepared by the wizard and pasted
